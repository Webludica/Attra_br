...
function register_section_for_io_section( $wp_customize ) {
	...
	$wp_customize->add_section( 'io_section', array(
		...
		//'description' => __('All themes from ThemeMove share the same theme setting structure so you can export then import settings from one theme to another conveniently without any problem.', 'tm-core'),
		'priority' => 15000
	) );
}
